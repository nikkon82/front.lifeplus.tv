                                                    ...
                                                    >
                                                        ...
                                                        <div class="chat-block">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <img style="width: 100%;" src="/img/leedbot/naim/naim1.jpeg" alt=""/>
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Светлана, директор и главный редактор газеты.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    В LR искала продукт для здоровья детей. Получив ошеломляющие результаты, начала строить бизнес.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Через 8 месяцев получила VW Polo, а ещё через год, поменяла его на VW Tiguan.
                                                                    Через полтора года вышла на доход 100 000р и уволилась с работы.
                                                                </p>
                                                                ...
                                                                <transition name="fade">
                                                                    <div v-if="imgNaim2" class="mt-10">
                                                                        <p
                                                                            ...
                                                                            style="width: 100%; max-width: 550px; height: auto;"
                                                                        >
                                                                            <img style="width: 100%;" src="/img/leedbot/naim/naim2.jpeg" alt=""/>
                                                                        </p>
                                                                        <p
                                                                            class="mb-5"
                                                                        >
                                                                            Гэльсу, главный градостроитель.
                                                                        </p>
                                                                        <p
                                                                            class="mb-5"
                                                                        >
                                                                            В LR заинтересовала автопрограмма.
                                                                            Впоследствии вылечила бронхиальную астму продукцией LR.
                                                                        </p>
                                                                        <p
                                                                            class="mb-5"
                                                                        >
                                                                            Через полгода ежемесячный доход 60000 рублей, через год более 100000 руб.
                                                                            Получили уже 4 авто от компании.
                                                                        </p>
                                                            ...
                                                            >
                                                                <p
                                                                    ...
                                                                    style="width: 100%; max-width: 550px; height: auto;"
                                                                >
                                                                    <img style="width: 100%;" src="/img/leedbot/ent/ent1.jpeg" alt=""/>
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Дамир, предприниматель, розничная торговля бытовой техники.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    После кризиса 2014 года бизнес рухнул. Доходы со 100000 рублей в месяц упали до 26000.
                                                                    Платили ипотеку 23000. На жизнь оставалось 3000.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Бизнес с LR начала супруга Айнагуль, врач по профессии.
                                                                    Через 1,3 года получили первый Авто VW Polo. Ещё спустя 1,5 года получили второй авто  VW Tiguan.
                                                                </p>
                                                                <v-btn
                                                                    class="chat-btn"
                                                                ...
                                                                <transition name="fade">
                                                                    <div v-if="imgEnt5" class="mt-10">
                                                                        <p
                                                                            ...
                                                                            style="width: 100%; max-width: 550px; height: auto;"
                                                                        >
                                                                            <img style="width: 100%;" src="/img/leedbot/ent/ent5.jpeg" alt=""/>
                                                                        </p>
                                                                        <p
                                                                            class="mb-5"
                                                                        >
                                                            ...
                                                            >
                                                                <p
                                                                    ...
                                                                    style="width: 100%; max-width: 550px; height: auto;"
                                                                >
                                                                    <img style="width: 100%;" src="/img/leedbot/pfr/pfr1.jpeg" alt=""/>
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Игорь в прошлом врач реаниматолог, Татьяна врач педиатр, сейчас на пенсии.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Был опыт в сетевом, свои обучающие проекты. Но размер дохода не устраивал!
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Через полгода в LR вышли на доход 55000 руб, через год 72000 руб.
                                                                    Авто от LR получили через 5 месяцев сотрудничества. Съездили на обучение в Германию.
                                                                </p>
                                                                <v-btn
                                                                    class="chat-btn"
                                                                ...
                                                                <transition name="fade">
                                                                    <div v-if="imgPfr2" class="mt-10">
                                                                        <p
                                                                            ...
                                                                            style="width: 100%; max-width: 550px; height: auto;"
                                                                        >
                                                                            <img style="width: 100%;" src="/img/leedbot/pfr/pfr2.jpeg" alt=""/>
                                                                        </p>
                                                                        <p
                                                                            class="mb-5"
                                                                        >
                                                            ...
                                                            >
                                                                <p
                                                                    ...
                                                                    style="width: 100%; max-width: 550px; height: auto;"
                                                                >
                                                                    <img style="width: 100%;" src="/img/leedbot/mlm/mlm1.jpeg" alt=""/>
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Людмила. Мама троих деток.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    12 лет строила бизнес в американской сетевой компании, разочаровалась и вернула себе статус
                                                                    «Мама в декрете».
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    В LR пришла потому, что хотелось иметь личные деньги и быть финансово не зависимой от супруга.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    На второй месяц чек был около 30 000 руб, а через год 80 000 рублей.
                                                                    Первый авто получили на четвёртый месяц. Готовимся получать 4 авто VW TOUAREG.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Благодаря LR закрыли ВСЕ ДОЛГИ - ипотека и кредиты. Мы свободны во времени и
                                                                    не привязаны к месту жительства.
                                                                    Сегодня мы делаем дизайнерский ремонт в нашей квартире.
                                                                </p>
                                                                <v-btn
                                                                    class="chat-btn"
                                                                ...
                                                                <transition name="fade">
                                                                    <div v-if="imgMlm3" class="mt-10">
                                                                        <p
                                                                            ...
                                                                            style="width: 100%; max-width: 550px; height: auto;"
                                                                        >
                                                                            <img style="width: 100%;" src="/img/leedbot/mlm/mlm3.jpeg" alt=""/>
                                                                        </p>
                                                                        <p
                                                                            class="mb-5"
                                                                        >
                                                            ...
                                                            >
                                                                <p
                                                                    ...
                                                                    style="width: 100%; max-width: 550px; height: auto;"
                                                                >
                                                                    <img style="width: 100%;" src="/img/leedbot/dekret/dekret1.jpeg" alt=""/>
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Алия, многодетная мама, начала бизнес в декрете.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    На пятый год декрета поняла что деградирую и что очень сильно устала от бесконечных болезней детей.
                                                                    Поэтому когда однажды в соцсети прилетело предложение о партнёрстве с LR, решила рассмотреть.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Уже спустя восемь месяцев забыла про болезни детей, вышла на первый доход 18000 руб,
                                                                    а через год уже ездила на машине и доход составлял 72000₽.
                                                                    Ещё через год и девять месяцев получила вторую машину Тигуан.
                                                                </p>
                                                                <v-btn
                                                                    class="chat-btn"
                                                                ...
                                                                <transition name="fade">
                                                                    <div v-if="imgDekret4" class="mt-10">
                                                                        <p
                                                                            ...
                                                                            style="width: 100%; max-width: 550px; height: auto;"
                                                                        >
                                                                            <img style="width: 100%;" src="/img/leedbot/dekret/dekret4.jpeg" alt=""/>
                                                                        </p>
                                                                        <p
                                                                            class="mb-5"
                                                                        >
                                                                            Аида, в прошлом репетитор иностранных языков.
                                                                        </p>
                                                                        <p
                                                                            class="mb-5"
                                                                        >
                                                                            В LR пришла будучи в декрете со вторым ребенком, потому что осознала,
                                                                            что по другому не достигну высоких финансовых результатов.
                                                                        </p>
                                                                        <p
                                                                            class="mb-5"
                                                                        >
                                                                            Через год получила первый автомобиль, через 2 года переехала в большой город из провинции.
                                                                            Благодаря доходу и перспективам родила ещё 2х детей.
                                                                        </p>
                                                                        <v-btn
                                                                            class="chat-btn"
                                                            ...
                                                            >
                                                                <p
                                                                   class="mb-5"
                                                                    style="width: 100%; max-width: 550px; height: auto;"
                                                                >
                                                                    <img style="width: 100%;" src="/img/leedbot/dom/dom1.jpeg" alt=""/>
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Елена, домохозяйка и мама четверых детей.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    В ЛР пришла, чтобы не зависеть от мужа, самореализоваться, не смотреть на цены в магазине.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    Через пол года вышла на доход 18000 ₽, через полтора года на 90000₽.
                                                                    Через год получила машину от компании.
                                                                </p>
                                                                <p
                                                                    class="mb-5"
                                                                >
                                                                    С ЛР начали осуществляться мои мечты: за год путешествовала 10 раз и осуществляю
                                                                    свои женские хотелки (покупки, фитнес, разные процедуры).
                                                                </p>
                                                                <v-btn
                                                                    class="chat-btn"
    ...
    created() {
        if (!this.$route.query.p) {
            if (this.$cookies.isKey('lifeplus_partner')) {
                ...
                this.$router.push ({name: 'Leedbot', query: { p: partnerNum }})
            }
        } else {
