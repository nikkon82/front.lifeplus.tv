                ...
                >
                    <template v-slot:top>
                        <v-toolbar flat color="white">
                            <v-toolbar-title>Мои заявки - Корзина</v-toolbar-title>
                            <v-divider
                                class="mx-4"
                                inset
                                vertical
...
export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Восстановить', value: 'restore' },
        ],
        loading: true
    }),
    computed: {
        ...mapGetters({
            prospects: 'user/getProspectsBasket'
        })
    },
    created () {
        this.initialize()
    ...
    methods: {
        ...mapActions({
            ...
            loadProspects: 'user/loadProspectsBasket',
            restoringProspect: 'prospect/restoreUserProspect',
        }),
        getColorStep (step) {
