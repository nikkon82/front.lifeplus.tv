            ...
            <section id="biz-page">
                <v-row no-gutters>
                    ...
                    >
                        ...
                        <p class="biz-title">LR остается на Украинском рынке и сдерживает рост цен на свои продукты, выигрывая тем самым и по качеству, и по цене.</p>
                    </v-container>
...
export default {
    ...
    data: () => ({
        ...
        slides: [
            {
                src: '/img/leedbot/UA/history/history-ua-6.png',
                title: 'Наемный работник',
            },
            {
                src: '/img/leedbot/UA/history/history-ua-21.png',
                title: 'Мама в декрете',
            },
            {
                src: '/img/leedbot/UA/history/history-ua-8.png',
                title: 'Домохозяйка',
            },
            {
                src: '/img/leedbot/UA/history/history-ua-15.png',
                title: 'Пенсионер',
            },
            // {
            ...
            // },
            {
                src: '/img/leedbot/UA/history/history-ua-5.png',
                title: 'Предприниматель',
            },
            {
                src: '/img/leedbot/UA/history/history-ua-14.png',
                title: 'Фрилансер',
            }
        ],
        errors: {},
    ...
    created() {
        if (!this.$route.query.p) {
            if (this.$cookies.isKey('lifeplus_partner')) {
                ...
                this.$router.push ({name: 'BizPrezaUA', query: { p: partnerNum }})
            }
        } else {
